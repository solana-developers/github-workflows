...
jobs:
  build:
    uses: solana-developers/github-workflows/.github/workflows/reusable-build.yaml@v0.2.2
    with:
      program: "hello_world"
      network: "devnet"
      deploy: true
...
jobs:
  test:
    uses: solana-developers/github-workflows/.github/workflows/test.yaml@v0.2.2
    with:
      program: ${{ 'transaction_example' }}
```
